<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UploadCourseMaterial.aspx.cs" Inherits="OTeaching.Instructor.UploadCourseMaterial" %>
...
<body>
    ...
    <asp:HiddenField ID="hfUploadID" runat="server" />
             <div class="form-group">
                    <asp:Label ID="lblInstructorCourseID" runat="server" CssClass="col-md-2 control-label" Text="InstructorCourseID"></asp:Label>
                    <div class="col-md-3">
                        <asp:TextBox ID="txtInstructorCourseID" CssClass="form-control" runat="server" ReadOnly="True"></asp:TextBox>
                        </div>
                </div>
            <div class="form-group">
