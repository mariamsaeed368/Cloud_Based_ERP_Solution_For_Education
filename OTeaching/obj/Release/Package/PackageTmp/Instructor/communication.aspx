<%@ Page Title="" Language="C#" MasterPageFile="~/Instructor/Instructor.Master" AutoEventWireup="true" CodeBehind="communication.aspx.cs" Inherits="OTeaching.Instructor.communication" %>
<asp:Content ID="Content1" ContentPlaceHolderID="c1" runat="server">
     <div class="row" style="margin:10px;">
        <div class="col-lg-12" style="height:400px; border-style:solid; border-width:1px; background-color:white; overflow:auto;" id="msgarea">
        ...
        <div class="col-lg-12" style="height:80px; border-style:solid; border-width:1px; background-color:white; margin-top:5px">
            ...
            <input type="text" id="username" value="<% Response.Write(Session["Instructor_username"].ToString()); %>" style="display:none" />
    <script type="text/javascript">
        ...
        function send_message() {
            ...
            xmlhttp.open("GET", "messages_send_from_teacher.aspx?Studentusername=" + username + "&message=" + document.getElementById("t1").value, true);
            xmlhttp.send();
