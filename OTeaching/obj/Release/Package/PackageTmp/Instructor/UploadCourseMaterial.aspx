...
<asp:Content ID="Content1" ContentPlaceHolderID="c1" runat="server">
    ...
    <asp:HiddenField ID="hfUploadID" runat="server" />
             <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <asp:TextBox ID="txtClassCourseID" CssClass="form-control" runat="server" ReadOnly="True" Height="38px"></asp:TextBox>
                        </div>
                </div>
            <div class="form-group">
                 <asp:Label ID="lblFileName" runat="server" CssClass="col-md-2 control-label" Text="File Name"></asp:Label>
                    <div class="col-md-3">
                        <asp:TextBox ID="txtFileName" CssClass="form-control" runat="server" Height="38px"></asp:TextBox>
                     </div>
                </div>
         <div class="form-group">
