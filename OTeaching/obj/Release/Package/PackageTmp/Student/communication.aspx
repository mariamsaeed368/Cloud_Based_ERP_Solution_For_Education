<%@ Page Title="" Language="C#" MasterPageFile="~/Student/Student.Master" AutoEventWireup="true" CodeBehind="communication.aspx.cs" Inherits="OTeaching.Student.check" %>
<asp:Content ID="Content1" ContentPlaceHolderID="c1" runat="server">
      <div class="row" style="margin:10px;">
        ...
        <div class="col-lg-12" style="height:80px; border-style:solid; border-width:1px; background-color:white; margin-top:5px">
            ...
            <input type="text" id="username" value="<% Response.Write(Session["Student_Username"].ToString()); %>" style="display:none" />
    <script type="text/javascript">
        ...
        function send_message() {
            ...
            xmlhttp.open("GET", "messages_send_from_student.aspx?Instructorusername=" + username + "&message=" + document.getElementById("t1").value, true);
            xmlhttp.send();
