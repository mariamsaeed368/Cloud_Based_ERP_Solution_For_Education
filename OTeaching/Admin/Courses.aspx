        ...
        <a class="nav-link" href="../Default.aspx">Logout</a>
            ...
            <div class="form-horizontal">
             ...
             <div class="form-group">
                 ...
                 <div>
                     <asp:Label ID="lblCourseName" runat="server"  Text=" " ForeColor="Red"></asp:Label>
                 </div>
                        </div>
                </div>
                <div class="form-group">
                    <asp:Label ID="Label9" runat="server" CssClass="col-md-2 control-label" Text="Course No"></asp:Label>
                    <div class="col-md-3">
                        <asp:TextBox ID="txtCourseNo" CssClass="form-control" runat="server"></asp:TextBox>
                 <div>
                     <asp:Label ID="lblCourseNo" runat="server"  Text=" " ForeColor="Red"></asp:Label>
                 </div>
                        </div>
                </div>
                <div class="form-group">
                 ...
                 <div>
                     <asp:Label ID="lblDescription" runat="server"  Text=" " ForeColor="Red"></asp:Label>
                 </div>
                        </div>
                </div>
              <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <asp:Button ID="btnAdd" runat="server" Text="Add" CssClass="btn btn-success" style="font-family: Arial" OnClick="btnAdd_Click" Width="98px"/>
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="CourseDescription" HeaderText="Course Description"/>
                     <asp:TemplateField>
                      ...
                      <asp:TemplateField>
                        <ItemTemplate>
                            <asp:LinkButton ID="lnkassigninstructor" runat="server" CommandArgument='<%# Eval("CourseID")%>' OnClick="lnkassigninstructor_OnClick">Assign Instructor</asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
