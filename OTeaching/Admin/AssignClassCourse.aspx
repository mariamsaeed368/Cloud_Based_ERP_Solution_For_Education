...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AssignClassCourse.aspx.cs" Inherits="OTeaching.Admin.AssignClassCourse" %>
    ...
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
      <li class="nav-item active">
       ...
       <div class="form-horizontal">
          ...
          <hr/>
           <asp:HiddenField ID="hfClassCourseID" runat="server" />
           <div class="form-group">
                    <asp:Label ID="lblInstructorCourseID" runat="server" CssClass="col-md-2 control-label" Text="Instructor Course ID"></asp:Label>
                    <div class="col-md-3">
                        <asp:TextBox ID="txtInstructorCourseID" CssClass="form-control" runat="server" Enabled="False"></asp:TextBox>
                 <div>
            ...
            <div class="form-group">
                    <asp:Label ID="lblSection" runat="server" CssClass="col-md-2 control-label" Text="Section"></asp:Label>
                    <div class="col-md-3">
            ...
            <hr />
                ...
                <Columns>
                    <asp:BoundField DataField="InstructorCourseID" HeaderText="InstructorCourseID"/>
                    <asp:BoundField DataField="ClassName" HeaderText="Class Name"/>
                    <asp:BoundField DataField="Section" HeaderText="Section"/>
                    <asp:BoundField DataField="AssignedOn" HeaderText="Assigned On"/>
                     <asp:TemplateField>
                        <ItemTemplate>
                            <asp:LinkButton ID="lnkview" runat="server" CommandArgument='<%# Eval("ClassCourseID")%>' OnClick="lnk_OnClick">View</asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
