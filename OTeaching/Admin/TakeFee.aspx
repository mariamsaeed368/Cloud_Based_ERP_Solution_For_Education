      ...
      <li class="nav-item active">
        ...
        <a class="nav-link" href="../Default.aspx">Logout</a>
            ...
            <div class="form-horizontal">
                ...
                <h2>Take Fee</h2>
                <hr/>
                 <asp:HiddenField ID="hfTakeFeeID" runat="server" />
             <div class="form-group">
                    <asp:Label runat="server" CssClass="col-md-2 control-label" Text="Student's Registration No."></asp:Label>
                    <div class="col-md-3">
                        <asp:TextBox ID="txtstdregno" CssClass="form-control" runat="server" Enabled="False" ReadOnly="True"></asp:TextBox>
                 <div>
                     <asp:Label ID="lblstdregno" runat="server"  Text=" " ForeColor="Red"></asp:Label>
                 </div>
                        </div>
                </div>
                <div class="form-group">
                    <asp:Label runat="server" CssClass="col-md-2 control-label" Text="Class Fee"></asp:Label>
                    <div class="col-md-3">
                        <asp:TextBox ID="txtClassFee" CssClass="form-control" runat="server" Enabled="False" ReadOnly="True"></asp:TextBox>
                 <div>
                     <asp:Label ID="lblClassFee" runat="server"  Text=" " ForeColor="Red"></asp:Label>
                 </div>
                        </div>
                </div>
                <div class="form-group">
                    <asp:Label runat="server" CssClass="col-md-2 control-label" Text="Date"></asp:Label>
                    <div class="col-md-3">
            ...
            <hr />
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="TotalFee" HeaderText="Class Fee"/>
                    <asp:BoundField DataField="Date" HeaderText="Date"/>
                     <asp:TemplateField>
                        <ItemTemplate>
                            <asp:LinkButton ID="lnkview" runat="server" CommandArgument='<%# Eval("TakeFeeID")%>' OnClick="lnk_OnClick">View</asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
