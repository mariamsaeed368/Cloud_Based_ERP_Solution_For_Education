<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InstructorRegistration.aspx.cs" Inherits="OTeaching.Admin.Instructor" %>
        ...
        <div class="form-horizontal">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
              ...
              <div class="form-group">
                 <asp:Label ID="qualification" runat="server" CssClass="col-md-2 control-label" Text="Qualification"></asp:Label>
                    <div class="col-md-3">
                        <asp:TextBox ID="tbqualification" CssClass="form-control" runat="server" placeholder="Qualification"></asp:TextBox>
                </div>
            </div>
             <div class="form-group">
                 <asp:Label ID="experience" runat="server" CssClass="col-md-2 control-label" Text="Experience"></asp:Label>
                    <div class="col-md-3">
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false"  GridLines="None" AllowPaging="true" CssClass="mGrid" PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt" Width="870px">
                  <Columns>
