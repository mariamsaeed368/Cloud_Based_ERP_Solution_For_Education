<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminLogin.aspx.cs" Inherits="OTeaching.AdminLogin" %>
  ...
  <div class="container">
     ...
     <div class="form-group">
            ...
            <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <asp:TextBox ID="tbpass" CssClass="form-control" runat="server"></asp:TextBox>
                </div>
                </div>
                 <div class="form-group">
